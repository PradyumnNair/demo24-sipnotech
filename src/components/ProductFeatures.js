...
const ProductFeatures = props => {
  ...
  return (
    <section className="product-features" id={'why'}>
      ...
      <div className="core-features">
        <div className="core-feature-1">
          ...
          <h2>Passion.</h2>
          <p>We are extremely passionate of our work and take pride in every project that we do. </p>
        </div>
        ...
        <div className="core-feature-2">
          ...
          <h2>Design focus.</h2>
          <p>Well designed and complete digital solutions . </p>
        </div>
      </div>
    </section>
  )
